...
"C:\\Users\\Administrator\\Desktop\\Testing\\chromedriver.exe");
...
driver.get("https://alada.vn/tai-khoan/dang-ky.html");
driver.findElement(By.id("txtFirstname")).sendKeys("luongho22@.com");
driver.findElement(By.id("txtEmail")).sendKeys("luongho22@.com");
driver.findElement(By.id("txtCEmail")).sendKeys("luongho22@.com");
...
driver.get("https://alada.vn/tai-khoan/dang-ky.html");
driver.findElement(By.id("txtFirstname")).sendKeys("luong ho");
driver.findElement(By.id("txtEmail")).sendKeys("thiluong15052001@gmail.com");
driver.findElement(By.id("txtCEmail")).sendKeys("luongho@gmail.com");
driver.findElement(By.id("txtPassword")).sendKeys("010101");
driver.findElement(By.id("txtCPassword")).sendKeys("010101");
driver.findElement(By.id("txtPhone")).sendKeys("0123456789");
driver.findElement(By.xpath("//form[@id='frmLogin']//button[text()='ĐĂNG KÝ'] ")).click();
...
driver.findElement(By.id("txtFirstname")).sendKeys("luong ho");
driver.findElement(By.id("txtEmail")).sendKeys("thiluong15052001@gmail.com");
driver.findElement(By.id("txtCEmail")).sendKeys("thiluong15052001@gmail.com");
